 ...
 * @see http://src.opensolaris.org/source/xref/sfw/usr/src/cmd/gcc/gcc-3.4.3/libjava/java/lang/
...
public abstract class MathUtil {
	...
	private static final double ieee754_pow(double x, double y)
	{
		...
		// GCJ LOCAL: This used to be (hx>>31)+1 but ANSI C says a
		// right shift of a signed negative quantity is implementation defined.
		n = (hx>>>31)-1;
	...
	private static final double ieee754_atan2 (double x, double y)
	{
		...
		switch (m) {
		    ...
		    case 1: // __HI(z) ^= 0x80000000;
		    	z = Double.longBitsToDouble(Double.doubleToLongBits(z) ^ 0x8000000000000000L);
			    return       z  ;	/* atan(-,+) */
